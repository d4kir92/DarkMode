				...
				DarkMode:CreateMinimapButton(
					{
						...
						["icon"] = 136122,
						["dbtab"] = DMTAB,
						["vTT"] = {{"DarkMode |T136122:16:16:0:0|t", "v|cff3FC7EB0.5.125"}, {DarkMode:Trans("LEFTCLICK"), DarkMode:Trans("MMBTNLEFT")}, {DarkMode:Trans("RIGHTCLICK"), DarkMode:Trans("MMBTNRIGHT")}},
						["funcL"] = function()
