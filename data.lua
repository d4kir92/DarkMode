...
local DMUi = {
	...
	["Minimap"] = {"QuestTimerFrame", "CalendarButtonFrame", "MiniMapBattlefieldFrameBorder", "MiniMapBattlefieldBorder", "MinimapBorder", "MinimapBorderTop", "TimeManagerClockButton", "MinimapCompassTexture", "MinimapCluster.BorderTop",},
