...
local function DMGetTypeColor(key, default, customName, texture)
	local cache = colorCache[key]
	if cache == nil then
		if type(default) == "string" then default = DarkMode:GetColorModeID(default) end
		local mode = DarkMode:DMGV(key, default)
		local r, g, b, a = DarkMode:GetColor(mode, customName)
		cache = {
			["r"] = r,
			["g"] = g,
			["b"] = b,
		...
		if DMIsDBReady() then colorCache[key] = cache end
	end
...
function DarkMode:GetUiColor(texture, from)
	return DMGetTypeColor("COLORMODE", 1, "CUSTOMUIC", texture)
end

function DarkMode:GetUFColor(texture)
	return DMGetTypeColor("COLORMODEUNFR", 1, "CUSTOMUFC", texture)
end

function DarkMode:GetBtnsColor(texture)
	return DMGetTypeColor("COLORMODEABTNS", "Off", "CUSTOMBTNS", texture)
end

function DarkMode:GetUFDRColor(texture)
	return DMGetTypeColor("COLORMODEAUNFRDRA", "Off", "CUSTOMUFDRC", texture)
end

function DarkMode:GetUFHPColor(texture)
	return DMGetTypeColor("COLORMODEAUNFRHPA", "Off", "CUSTOMUFHPC", texture)
end

function DarkMode:GetUFPORColor(texture)
	return DMGetTypeColor("COLORMODEAUNFRPORA", "Off", "CUSTOMUFPORC", texture)
end

function DarkMode:GetUFREPColor(texture)
	return DMGetTypeColor("COLORMODEAUNFRREPA", "Off", "CUSTOMUFREC", texture)
end

function DarkMode:GetNPColor(texture)
	return DMGetTypeColor("COLORMODENP", 1, "CUSTOMNPC", texture)
end

function DarkMode:GetTTColor(texture)
	return DMGetTypeColor("COLORMODETT", 1, "CUSTOMTTC", texture)
end

function DarkMode:GetActionButtonsColor(texture)
	return DMGetTypeColor("COLORMODEAB", 1, "CUSTOMABC", texture)
end

function DarkMode:GetBagsColor(texture)
	return DMGetTypeColor("COLORMODEBA", 1, "CUSTOMBAC", texture)
end

function DarkMode:GetMicroMenuColor(texture)
	return DMGetTypeColor("COLORMODEMI", 1, "CUSTOMMIC", texture)
end

function DarkMode:GetBuffsAndDebuffsColor(texture)
	return DMGetTypeColor("COLORMODEBAD", 1, "CUSTOMBADC", texture)
end

function DarkMode:GetAddonsColor(texture)
	return DMGetTypeColor("COLORMODEFA", 1, "CUSTOMFRAC", texture)
end

function DarkMode:GetFrameColor(texture)
	return DMGetTypeColor("COLORMODEF", 1, "CUSTOMFRC", texture)
end
...
local DMUi = {
	...
	["Artworks"] = {"MainStatusTrackingBarContainer.StandaloneFrameTextureRightCapTop", "MainStatusTrackingBarContainer.StandaloneFrameTextureLeftCapTop", "MainStatusTrackingBarContainer.StandaloneFrameTextureRightCapBottom", "MainStatusTrackingBarContainer.StandaloneFrameTextureLeftCapBottom", "MainStatusTrackingBarContainer.StandaloneFrameTexture1", "MainStatusTrackingBarContainer.StandaloneFrameTexture2", "MainStatusTrackingBarContainer.StandaloneFrameTexture3", "MainStatusTrackingBarContainer.StandaloneFrameTexture4", "MainStatusTrackingBarContainer.StandaloneFrameTexture5", "MainStatusTrackingBarContainer.MainMenuBarFrameTexture1", "MainStatusTrackingBarContainer.MainMenuBarFrameTexture2", "MainStatusTrackingBarContainer.MainMenuBarFrameTexture3", "MainStatusTrackingBarContainer.MainMenuBarFrameTexture4", "PVPTimerFrame", "PaladinPowerBarFrame", "PaladinPowerBarFrame.ActiveTexture", "PaladinPowerBarFrame.Background", "TimerTrackerTimer1StatusBarBorder", "TimerTrackerTimer2StatusBarBorder", "MirrorTimer1", "MirrorTimer2", "MirrorTimer3", "MainActionBar.BorderArt", "MainActionBarTextureExtender", "MainMenuBar.BorderArt", "MainMenuBarTextureExtender", "StanceBarLeft", "StanceBarMiddle", "StanceBarRight", "StanceButton1NormalTexture2", "StanceButton2NormalTexture2", "StanceButton3NormalTexture2", "StanceButton4NormalTexture2", "StanceButton5NormalTexture2", "StanceButton6NormalTexture2", "StanceButton7NormalTexture2", "StanceButton8NormalTexture2", "SlidingActionBarTexture0", "SlidingActionBarTexture1", "MainMenuBarTexture0", "MainMenuBarTexture1", "MainMenuBarTexture2", "MainMenuBarTexture3", "MainMenuExpBar", "ReputationWatchBar.StatusBar", "MainStatusTrackingBarContainer.BarFrameTexture", "SecondaryStatusTrackingBarContainer.BarFrameTexture", "MainMenuBarMaxLevelBar", "BT4BarBlizzardArt", "BT4BarBlizzardArt.nineSliceParent", "BlizzardArtLeftCap", "BlizzardArtRightCap", "CompactRaidFrameManager", "BagsBar.BorderArt", "MicroMenu.BorderArt"},
	["Gryphons"] = {"MA_LeftEndCap", "MA_RightEndCap", "MainMenuBar.EndCaps", "MainMenuBarLeftEndCap", "MainMenuBarRightEndCap", "MainActionBar.EndCaps", "MainActionBar.EndCaps.LeftEndCap.Texture", "MainActionBar.EndCaps.RightEndCap.Texture"},
...
local DMUiAddons = {"ExpansionUtilsSettings", "ExpansionUtilsCharacterOverview", "AchievementsUtilsSettings", "ArmoryUtilsSettings", "AutoQueueSettings", "CenteredSettings", "ChatUtilsSettings", "CVARsSettings", "DRaidFramesSettings", "DUnitFramesSettings", "HealerHelperSettings", "HealerProtectionSettings", "HighLevelAlertSettings", "IASettings", "InterruptTrackSettings", "LossOfControlMessagesSettings", "MALock", "MAProfiles", "MidnightNameplatesSettings", "MissingPowerSettings", "PersonalResourceSettings", "SpecBisTooltipSettings", "TankHelperSettings", "ThreatMeterSettings", "TooltipUtilsSettings", "UnitFrameUtilsSettings", "LFGListInviteDialog.Border", "LFDRoleCheckPopup.Border", "UIWidgetPowerBarContainerFrame", "TimerTrackerTimer1StatusBarBorder", "TimerTrackerTimer2StatusBarBorder", "FocusFrame.FocusFrameContainer.FrameTexture", "ArenaPrepFrame1Texture", "ArenaPrepFrame2Texture", "ArenaPrepFrame3Texture", "ArenaPrepFrame4Texture", "ArenaPrepFrame5Texture", "ArenaEnemyFrame1Texture", "ArenaEnemyFrame2Texture", "ArenaEnemyFrame3Texture", "ArenaEnemyFrame4Texture", "ArenaEnemyFrame5Texture",}
